...
export default function WorldPage() {
  ...
  const worldNews = articles.world || []

  // Calculate pagination
  const totalPages = Math.ceil(worldNews.length / articlesPerPage)
  const startIndex = (currentPage - 1) * articlesPerPage
  const endIndex = startIndex + articlesPerPage
  const currentArticles = worldNews.slice(startIndex, endIndex)
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-12">
          <h1 className="text-4xl font-serif font-light text-foreground mb-4">World News</h1>
